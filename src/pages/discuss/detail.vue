<template>
  <q-page>
    <div>
       <detail-component :did="did"></detail-component>
        <add-common-component :did="did"></add-common-component>
      <q-card>
...
import detailComponent from 'components/discuss/detailComponent.vue';
import commonItemComponent from 'components/discuss/commentItemComponent.vue';
import addCommonComponent from 'components/discuss/addCommentComponent.vue';
