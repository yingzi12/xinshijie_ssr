...
import adminItemComponent from 'components/discuss/adminItemComponent.vue';
...
async  function getList(){
  ...
  const response =await api.get("/admin/discuss/listAdmin?"+ tansParams(queryParams.value));
